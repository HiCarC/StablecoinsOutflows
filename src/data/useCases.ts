...
export const useCases: UseCaseDefinition[] = [
  {
    ...
    highlight: 'Deepest liquidity engine for stablecoins',
    insightBullets: [
    ...
    sources: [
      { label: 'Artemis (2025-05), Stablecoin Payments from the Ground Up', url: 'https://reports.artemisanalytics.com/stablecoins/artemis-stablecoin-payments-from-the-ground-up-2025.pdf' },
      { label: 'Keyrock (2025), Onchain Value: Stablecoins Now Drive Over ⅓ of DeFi Revenue', url: 'https://keyrock.com/onchain-value-stablecoins-now-drive-over-a-third-of-defi-revenue/' },
      { label: 'Visa (2025-08), Visa Onchain Analytics Dashboard', url: 'https://visaonchainanalytics.com/' },
    ],
  ...
  },
  {
    ...
    sources: [
      { label: 'Visa (2025-08), Visa Onchain Analytics Dashboard', url: 'https://visaonchainanalytics.com/' },
      { label: 'Boston Consulting Group (2025-05), Stablecoins: Five killer tests to gauge their potential', url: 'https://media-publications.bcg.com/Stablecoins-five-killer-tests-to-gauge-their-potential.pdf' },
      { label: 'a16z crypto (2025-06-20), 5 charts that explain crypto right now', url: 'https://a16zcrypto.com/posts/article/5-charts-explain-crypto/' },
    ],
  ...
  },
  {
    ...
    sources: [
      { label: 'Artemis (2025-05), Stablecoin Payments from the Ground Up', url: 'https://reports.artemisanalytics.com/stablecoins/artemis-stablecoin-payments-from-the-ground-up-2025.pdf' },
      { label: 'Flashbots research - MEV landscape', url: 'https://flashbots.net' },
    ],
  ...
  },
  {
    ...
    sources: [
      { label: 'IMF Working Paper (2025-07-11), Decrypting Crypto: How to Estimate International Stablecoin Flows', url: 'https://www.imf.org/en/Publications/WP/Issues/2025/07/11/Decrypting-Crypto-How-to-Estimate-International-Stablecoin-Flows-568260' },
      { label: 'BIS Bulletin No. 108 (2025-07-11), Stablecoin growth – policy challenges and approaches', url: 'https://www.bis.org/publ/bisbull108.htm' },
      { label: 'Artemis (2025-05), Stablecoin Payments from the Ground Up', url: 'https://reports.artemisanalytics.com/stablecoins/artemis-stablecoin-payments-from-the-ground-up-2025.pdf' },
    ],
  ...
  },
  {
    ...
    sources: [
      { label: 'Artemis (2025-05), Stablecoin Payments from the Ground Up', url: 'https://reports.artemisanalytics.com/stablecoins/artemis-stablecoin-payments-from-the-ground-up-2025.pdf' },
      { label: 'Boston Consulting Group (2025-05), Stablecoins: Five killer tests to gauge their potential', url: 'https://media-publications.bcg.com/Stablecoins-five-killer-tests-to-gauge-their-potential.pdf' },
      { label: 'McKinsey (2025-07-21), The stable door opens: How tokenized cash enables next-gen payments', url: 'https://www.mckinsey.com/industries/financial-services/our-insights/the-stable-door-opens-how-tokenized-cash-enables-next-gen-payments' },
    ],
